...
TERMS = [
    ...
    "NSFW-Emoji", "Schlimmstes Date-Ende", "Peinlichster Chat-Screenshot", "Essen", "Stripper-Name", "Schlechtester Anmachspruch",
    "Film", "Getränk", "Spitzname", "Verbotene Fantasie", "Lustige Ausrede", "Sexspielzeug", "Kink", "Anmachspruch", "Kuchen"
]
